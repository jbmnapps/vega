    ...
    <div style={{
      ...
      {editMode && !tweaksOpen && (
        <button onClick={() => setTweaksOpen(true)} style={{
          ...
          background: TOKENS.ink, color: '#f4efe7', border: 'none',
    ...
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '0 0 120px' }}>
        ...
        <div style={{ padding: '0 20px' }}>
          <Card padding={0}>
            <ProfileRow label="Fødselsdag" value="12. marts 2023" />
            <Divider inset={18} />
            <ProfileRow label="Race" value="Blandet" />
            <Divider inset={18} />
            <ProfileRow label="Dagligt mål" value="220 kcal" />
            <Divider inset={18} />
            <ProfileRow label="Dyrlæge" value="Vesterbro Dyreklinik" />
          </Card>
        </div>
...
function ProfileRow({ label, value, chevron }) {
  return (
    <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: 6 }}>
          {[
            ...
            <button key={val} onClick={() => { app.setDay(val); onPersist({ dayState: val }); }} style={{
              ...
              color: app.day === val ? '#f4efe7' : TOKENS.ink,
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          <button onClick={() => { app.setShowPhoto(true); onPersist({ showPhoto: true }); }} style={{
            ...
            color: app.showPhoto ? '#f4efe7' : TOKENS.ink,
