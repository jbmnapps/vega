...
function IdagScreen({ app, onOpenLogger, onOpenProfile }) {
  ...
  return (
    <div style={{
      ...
      {/* === Cream gradient overlay — starts at ~name level, fully opaque by bottom === */}
      <div style={{
        position: 'absolute', left: 0, right: 0,
        top: 260, bottom: 0,
        background: `linear-gradient(180deg,
          rgba(244,239,231,0) 0%,
          rgba(244,239,231,0.35) 12%,
          rgba(244,239,231,0.7) 28%,
          rgba(244,239,231,0.9) 42%,
          ${TOKENS.bg} 58%,
          ${TOKENS.bg} 100%)`,
      ...
      <div style={{
        ...
        {/* Spacer — pushes Vega name to where gradient begins */}
        <div style={{ flex: '0 0 220px' }} />

        {/* Vega + status — sits right where cream gradient starts */}
        <button onClick={onOpenProfile} style={{
          background: 'transparent', border: 'none',
          padding: '0 20px 18px', cursor: 'pointer', textAlign: 'left',
          flexShrink: 0,
        }}>
          <div style={{
